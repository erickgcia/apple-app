...
const HowItWorks = () => {
  ...
  return (
    <article className="common-padding">
      <section className="screen-max-width">
        <div id="chip" className="flex-center w-full my-20">
          <img
            src={chipImg}
            alt="Chip A17 Apple device"
            width={180}
            height={180}
          />
        </div>
        <div className="flex flex-col items-center">
          ...
          <h3 className="hiw-title">A monster win for gaming.</h3>
          <p className="hiw-subtitle">
            It's here. The biggest redesign in the history of Apple GPUs.
          </p>
        </div>
        <section className="mt-10 md:mt-20 mb-14">
          ...
          <section className="hiw-text-container mt-8">
            <div className="flex flex-col flex-1 justify-center">
              ...
              <p className="hiw-text mt-4 g_fadeIn">
                Mobile{' '}
                <span className="text-white">
